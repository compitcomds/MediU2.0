  ...
  >
    ...
    <div class="my-10 grid grid-cols-2 gap-4 lg:grid-cols-4">
      ...
      >
        ...
        />
        <div
          class="absolute inset-0 top-0 hidden flex-col items-center justify-center rounded-2xl bg-black bg-opacity-75 opacity-0 transition-opacity duration-300 group-hover:opacity-100 lg:flex"
        >
