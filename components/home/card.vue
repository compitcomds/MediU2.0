<template>
  <div class="font-serif pt-6 lg:pt-20">
    ...
    <div class="flex flex-wrap lg:flex-nowrap gap-6">
        ...
        >
          <nuxt-link class="relative" :key="card.link" :to="card.link">
            ...
            <img
              :src="card.image"
              :alt="card.name"
              class="w-full object-cover rounded-md lg:h-96"
            />
          </nuxt-link>
          <div class="flex justify-between items-center gap-3">
            <nuxt-link
              :key="card.link"
              :to="card.link"
              class="flex bg-gray-200 mt-4 rounded-full px-2 py-2"
            >
              <!-- Heart Icon -->
              <svg
            ...
            <nuxt-link class="flex bg-gray-200 mt-4 rounded-full px-2 py-2"
              ><svg
                data-v-b581078d=""
                xmlns="http://www.w3.org/2000/svg"
                width="24"
          ...
          <div class="flex flex-col items-center mt-4">
            ...
            <div
              v-if="card.timer"
              class="mt-6 text-center text-lg text-slate-500"
            >
              ...
              >
                ...
                <span>:</span>
                <div class="p-2 mx-1 rounded">
                  <p>{{ card.timer.hours }}</p>
                  <span> hours</span>
                </div>
                <span>:</span>
                <div class="p-2 mx-1 rounded">
                  <p>{{ card.timer.minutes }}</p>
                  <span> mins</span>
                </div>
                <span>:</span>
                <div class="p-2 mx-1 rounded">
                  <p>{{ card.timer.seconds }}</p>
                  <span> secs</span>
                </div>
              </div>
            </div>
      ...
      <!-- Remaining Cards -->
      <div
        class="w-full lg:w-7/12 grid grid-cols-2 md:grid-cols-2 gap-2 lg:gap-6 capitalize font-sans"
      >
        <div
