  ...
  <div class="mb-10">
    ...
    <div class="flex flex-wrap lg:flex-nowrap gap-6">
      ...
      <div class="w-full lg:w-5/12">
        <nuxt-link
          v-for="product in filteredProducts.slice(0, 1)"
          :key="product.link"
          :to="product.link"
          ...
          <div class="mt-6 text-center">
            ...
            <div class="flex justify-center items-center my-2">
              ...
              <span class="ml-2 text-sm text-gray-500"
                >({{ product.feedbackCount }} Feedback)</span
              >
            </div>
            <div
              v-if="product.timer"
              class="mt-8 text-center text-md text-gray-500"
            >
      ...
      <div class="w-full lg:w-7/12 grid grid-cols-1 md:grid-cols-2 gap-6">
        <nuxt-link
          v-for="product in filteredProducts.slice(1)"
          :key="product.link"
          :to="product.link"
