    ...
    <div class="responsive-div flex flex-col lg:flex-row mb-8 overflow-hidden">
      ...
      <div class="w-full lg:w-8/12 lg:ml-4">
            ...
            <div class="mt-4 space-y-2">
              ...
              <div class="flex items-center justify-between mt-2">
                ...
                <div class="bg-slate-300 rounded-full px-1 py-1 opacity-80">
                  <a :href="product.url"><img src="https://ccdstest.b-cdn.net/Medi%20u/Bag.svg" class="w-6 sm:w-8 p-1"
                      alt="" /></a>
                </div>
              </div>
            </div>
        ...
        <div class="mt-4 text-right md:text-end">
          <nuxt-link to="/shop" class="text-blue-500 text-lg sm:text-xl md:text-2xl">Explore More →</nuxt-link>
        </div>
      </div>
    </div>
  </div>
