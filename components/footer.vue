  ...
  <footer class="bg-[#28574E] text-white py-8">
    ...
    >
      <div class="w-full md:w-1/3 mb-2 md:mb-0">
        ...
        <ul class="space-y-4">
          <li
            class="flex items-center font-bold lg:text-lg xl:text-xl mb-4 mt-16"
          >
            Contact Us
          </li>
          <li class="flex items-center space-x-2">
            ...
            <a href="https://wa.me/919090909090" class="hover:underline"
              >WhatsApp<br />
              +91 9090909090</a
            >
          </li>
          <li class="flex items-center space-x-2">
            ...
            <a href="tel:+918080808080" class="hover:underline"
              >Call Us<br />
              +91 8080808080</a
            >
          </li>
      ...
      >
        <h2 class="font-bold lg:text-lg xl:text-xl mb-4">
        ...
        <ul class="space-y-2 lg:text-base xl:text-lg">
          <li class="list-disc">
            <nuxt-link to="#" class="hover:underline"
              >Hydrating Serums</nuxt-link
            >
          </li>
          <li class="list-disc">
            <nuxt-link to="#" class="hover:underline"
              >Scalp Treatments</nuxt-link
            >
          </li>
          <li class="list-disc">
            <nuxt-link to="#" class="hover:underline"
              >Anti-Aging Creams</nuxt-link
            >
          </li>
          <li class="list-disc">
            <nuxt-link to="#" class="hover:underline"
              >Hair Repair Masks</nuxt-link
            >
          </li>
          <li class="list-disc">
            <nuxt-link to="#" class="hover:underline"
              >Leave-In Conditioners</nuxt-link
            >
          </li>
          <li class="list-disc">
            <nuxt-link to="#" class="hover:underline"
              >Brightening Creams</nuxt-link
            >
          </li>
          <li class="list-disc">
            <nuxt-link to="#" class="hover:underline"
              >Hair Growth Serums</nuxt-link
            >
          </li>
          <li class="list-disc">
            <nuxt-link to="#" class="hover:underline"
              >Anti-Frizz Products</nuxt-link
            >
          </li>
        </ul>
      </div>
      ...
      >
        ...
        <ul class="space-y-2 lg:text-base xl:text-lg">
          ...
          <li class="list-disc">
            <nuxt-link to="#" class="hover:underline">FAQ</nuxt-link>
          </li>
          <li class="list-disc">
            <nuxt-link to="#" class="hover:underline">Privacy Policy</nuxt-link>
          </li>
          <li class="list-disc">
            <nuxt-link to="#" class="hover:underline">E-waste Policy</nuxt-link>
          </li>
          <li class="list-disc">
            <nuxt-link to="#" class="hover:underline"
