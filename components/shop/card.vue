<template>
  ...
  <div class="my-2">
    <div
      class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 2xl:grid-cols-6 gap-4"
    >
      <div
      ...
      >
        <a
          class="border p-4 rounded-lg block no-underline border-gray-300 shadow-md"
        >
          <div class="relative">
            <span
              v-if="true"
