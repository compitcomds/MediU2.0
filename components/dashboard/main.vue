<template>
  <main class="w-3/4 h-screen">
    ...
    <div class="grid grid-cols-3 gap-4 mb-6">
      <div
        class="bg-white p-6 rounded-lg shadow-lg hover:bg-[#28574E] text-[#28574E] hover:text-white space-y-3"
      >
        <div class="border w-1/6 flex items-center justify-center p-2 bg-white">
          <svg
            width="36"
            height="37"
            viewBox="0 0 36 37"
