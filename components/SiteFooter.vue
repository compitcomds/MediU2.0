      ...
      <div class="w-full md:w-1/3 mb-2 md:mb-0">
        ...
        <ul class="space-y-4">
          ...
          <li class="flex items-center space-x-2">
            ...
            <a href="mailto:Radiancecosmeticstudio@gmail.com" class="hover:underline">
              radiancecosmeticstudio@gmail.com
            </a>
          </li>
          <li class="flex items-center space-x-2">
            <svg
            ...
            <a href="https://wa.me/+917820830842" class="hover:underline">
              +91 78208 30842</a
            >
          </li>
          <li class="flex items-center space-x-2">
            ...
            <a href="tel:+917820830842" class="hover:underline">
              +91 78208 30842</a
            >
          </li>
        </ul>
