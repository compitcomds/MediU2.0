      ...
      <div class="row align-center-center">
              ...
              <div class="form-row d-flex justify-content-between m-b35">
                <div class="form-group">
                  <div class="custom-control custom-checkbox">
                    ...
                    <label class="form-check-label m-0" for="basic_checkbox_2">Remember For 30 Days</label>
                  </div>
                </div>
                <div class="form-group">
                  <nuxt-link class="text-secondary text-decoration-underline" to="javascript:void(0);">Forgot Password</nuxt-link>
                </div>
              </div>
              <div class="">
                ...
                <p class="m-t15">
                  ...
                  <nuxt-link class="register text-primary font-weight-500" to="/auth/register">Sign up For
                    Free</nuxt-link>
                </p>
              </div>
            </form>
        ...
        <div class="col-xxl-6 col-xl-6 col-lg-6"  style="margin-top: 150px;">
          <div class="registration-media">
            <img src="https://ccdstest.b-cdn.net/Medi%20u/2.png" alt="/" />
          </div>
        </div>
...
const formData = useState("login-form", () => ({
  email: "",
  password: "",
}));
...
useHead({
  script: [
    {
      src: "/vendor/magnific-popup/magnific-popup.js",
