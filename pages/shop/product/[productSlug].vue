          ...
          <div class="space-y-4">
            ...
            <div class="my-2 flex items-center gap-2">
              <div class="text-3xl font-bold text-gray-900">
                <span class="text-[#383e42]"
                  >{{ data.price.currencyCode }} {{ data.price.amount }}</span
                >
                <span
            ...
            <div class="mb-4 text-sm text-gray-500">Inclusive of all Taxes</div>
                  ...
                  >
                    ...
                    >
                      <div class="rounded-lg border shadow-lg">
                        <div
                          class="rounded-t-md bg-[#383e42] p-2 font-semibold text-white"
                        >
