    ...
    <div v-if="data">
      <div class="grid grid-cols-5 gap-6 md:grid-cols-5">
        <div class="col-span-5 lg:col-span-2">
          <div class="col-span-5 lg:col-span-2">
            <!-- Main Swiper -->
            <swiper-container style="--swiper-navigation-color: #000; --swiper-pagination-color: #000" class="mySwiper"
              thumbs-swiper=".mySwiper2" space-between="15" navigation="true" pagination="true" autoplay="true"
