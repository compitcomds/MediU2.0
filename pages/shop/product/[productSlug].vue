<template>
  <div class="lg:mx-20 md:mt-5 lg:mt-10 sm:mx-2 sm:my-3 mx-2 my-3">
    <div v-if="data">
            ...
            <swiper-container style="
              ...
              <swiper-slide v-for="(item, index) in data.images" :key="item.url">
                <img :src="item.url" alt="Product Image"
                  class="lg:object-cover object-fill lg:w-full lg:h-full rounded-lg shadow-lg transition-transform duration-300 hover:scale-150 overflow-hidden" />
              </swiper-slide>
            </swiper-container>
          ...
          <div class="flex items-center space-x-3 mb-4">
            <div class="flex items-center gap-1 text-yellow-500">
              ...
              <div class="relative w-5 h-5">
                ...
                <!-- Half yellow star -->
                <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="currentColor"
                  class="absolute inset-0 text-yellow-500 overflow-hidden" style="clip-path: inset(0 50% 0 0);">
                  <polygon
                    points="12 2 15.09 8.26 22 9.27 17 14.14 18.18 21.02 12 17.77 5.82 21.02 7 14.14 2 9.27 8.91 8.26 12 2" />
                </svg>
              </div>
              ...
              <!-- Rating text -->
              <div class="text-gray-900 font-medium">4.5</div>
            </div>
          ...
          <div>
            ...
            <div v-for="(item, itemIndex) in data.options" :key="itemIndex" class="mb-4">
              <div v-if="item.name !== 'Title'">
                ...
                <div class="flex flex-wrap gap-4 overflow-x-scroll md:overflow-x-visible">
              ...
              <swiper :slidesPerView="1" :spaceBetween="60" :loop="true"
                ...
                <swiper-slide v-for="(item, index) in slides" :key="index">
                  <img :src="item" alt="Ad Banner"
                    class="w-full object-fill lg:object-cover h-32 rounded-lg flex justify-between items-center" />
                </swiper-slide>
              </swiper>
            </div>
        ...
        <div class="flex flex-col items-center">
          ...
          <div class="w-full bg-white border-1 border rounded-lg shadow-md">
            <div v-for="(item, index) in accordionKeys" :key="index">
              ...
              " class="p-4">
                <div v-html="data[item.value].value.split('\n').join('<br />')" class="text-gray-700 leading-relaxed">
                </div>
              </div>
            </div>
          </div>
  ...
  <div class="lg:mx-20 lg:my-20 sm:mx-2 sm:my-3 mx-2 my-3 p-6 bg-gray-50 rounded-lg shadow-lg mb-20 md:mb-28 lg:mb-10">
