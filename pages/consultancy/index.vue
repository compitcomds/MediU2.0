    ...
    <div class="flex  justify-center  lg:space-x-4 p-4 lg:p-16">
      <!-- Sidebar -->
        ...
        <div          
            ...
            >
              <span class="text-[#28574e] border-2 border-[#28574e] rounded-full hover:text-white text-xl font-semibold p-4 gap-4 w-full hover:bg-[#28574e] flex items-center justify-center">Continue
...
const tabClasses = (tab) => {
  return {
    'text-blue-600 font-semibold': router.currentRoute.value.name === tab,
    'text-gray-400': router.currentRoute.value.name !== tab,
  };
};
</script>
