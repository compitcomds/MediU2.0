<template>
  <div class="flex flex-col">
    <consult-banner />
    <div
      class="flex flex-col lg:flex-row justify-center lg:space-x-4 p-4 lg:p-16 bg-white"
    >
      <!-- Sidebar -->
      <aside
        class="w-full lg:w-60 bg-white shadow-lg rounded-md p-4 mb-4 md:mb-0 md:p-6 max-h-56"
      >
        <nav>
      ...
      <!-- Main content -->
      <main
        class="w-full lg:w-2/4 mb-20 my-4 lg:my-0 p-4 md:p-8 border border-[#28574e] rounded-xl h-auto"
      >
        <component
