<template>
    <div class="flex justify-center space-x-4 h-screen p-16 bg-white">
        ...
        <aside class="w-60 bg-white shadow-lg rounded-md p-6 max-h-56 ">
            <nav>
                <ul>
                    ...
                    }" class="mb-6 flex space-x-4" :style="tabStyle('service')">
                    ...
                    }" class="mb-6 flex space-x-4" :style="tabStyle('basicDetails')">
                    ...
                    }" class="mb-6 flex space-x-4" :style="tabStyle('summary')">
                    <svg class="w-6 h-6" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M0 0h24v24H0V0z" fill="none"></path><path d="M19 3h-4.18C14.4 1.84 13.3 1 12 1s-2.4.84-2.82 2H5c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2zm-7 0c.55 0 1 .45 1 1s-.45 1-1 1-1-.45-1-1 .45-1 1-1zM9.29 16.29L6.7 13.7c-.39-.39-.39-1.02 0-1.41.39-.39 1.02-.39 1.41 0L10 14.17l5.88-5.88c.39-.39 1.02-.39 1.41 0 .39.39.39 1.02 0 1.41l-6.59 6.59c-.38.39-1.02.39-1.41 0z"></path></svg>    
                    ...
                    }" class=" flex space-x-4" :style="tabStyle('confirmation')">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="black" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-calendar-check"><path d="M8 2v4"/><path d="M16 2v4"/><rect width="18" height="18" x="3" y="4" rx="2"/><path d="M3 10h18"/><path d="m9 16 2 2 4-4"/></svg>
        ...
        <main class="w-2/4 p-8 border border-[#28574e] rounded-xl">
            ...
            <component :is="currentTabComponent" @nextTab="handleNextTab" @serviceSelected="handleServiceSelected"
                @basicDetailsFilled="handleBasicDetailsFilled" @appointmentBooked="handleAppointmentBooked"></component>
        </main>
    </div>
</template>
