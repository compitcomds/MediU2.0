<template>
  <div class="flex justify-center space-x-4 p-16 bg-white">
    <!-- Sidebar -->
    <aside class="w-60 bg-white shadow-lg rounded-md p-6 max-h-56">
      <nav>
        <ul>
          <!-- Service Tab -->
          <li :class="tabClasses('service')" class="mb-6 flex space-x-4" :style="tabStyle('service')">
          ...
          <!-- Basic Details Tab -->
          <li :class="tabClasses('basicDetails')" class="mb-6 flex space-x-4" :style="tabStyle('basicDetails')">
          ...
          <!-- Summary Tab -->
          <li :class="tabClasses('summary')" class="mb-6 flex space-x-4" :style="tabStyle('summary')">
            <svg class="w-6 h-6" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
              <path d="M0 0h24v24H0V0z" fill="none"></path>
          ...
          <!-- Confirmation Tab -->
          <li :class="tabClasses('confirmation')" class="flex space-x-4" :style="tabStyle('confirmation')">
    ...
    <!-- Main content -->
    <main class="w-2/4 p-8 border border-[#28574e] rounded-xl h-auto">
      <component
...
export default {
  ...
  methods: {
    ...
    handleAppointmentBooked(appointmentDetails) {
      ...
      this.totalPrice = appointmentDetails.price; // Assuming appointmentDetails has a price property
      this.handleNextTab();
    },
    tabStyle(tab) {
      return {
