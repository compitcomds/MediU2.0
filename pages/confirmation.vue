<template>
  <div class="bg-white p-8 rounded-lg text-center max-w-3xl mx-auto">
    ...
    <h2 class="text-xl font-semibold text-[#28574e] mb-2">Booking ID: {{ bookingID }}</h2>
    <p class="text-xl font-semibold text-[#28574e] mb-4">Your Appointment has been booked successfully!</p>
    ...
    <div class="grid grid-cols-2 gap-6 mb-8">
      ...
      <div>
        ...
        <p class="text-lg text-[#28574e]">{{ note }}</p>
      </div>
    </div>

    <!-- Action Buttons -->
    <div class="text-center mt-4">
      <button @click="goToHome" class="bg-[#28574e] text-white px-6 py-2 rounded hover:bg-[#5c998e]">
        Go to Home
      </button>
    </div>
  </div>
