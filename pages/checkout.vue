<template>
    <div class="min-h-screen bg-gray-100 py-8 px-4 md:px-16 mb-20 lg:mb-0">
        <div class="max-w-7xl mx-auto grid lg:grid-cols-3 gap-8">
            ...
            <div class="lg:col-span-2 bg-white p-6 rounded-lg shadow-lg h-full overflow-y-auto">
                <!-- Contact Section -->
                <div class="mb-6">
                    <h2 class="text-2xl font-semibold mb-4 text-[#28574e]">Contact</h2>
                    <div class="flex flex-col space-y-2">
                        <input type="text" v-model="contact" placeholder="Email or mobile phone number"
                ...
                <div class="mb-6">
                    ...
                    <div class="space-y-4">
                        <div class="grid md:grid-cols-2 gap-4">
                            <input type="text" v-model="shipping.firstName" placeholder="First name (optional)"
                                class="p-3 border border-gray-300 rounded-lg w-full bg-white" />
                            <input type="text" v-model="shipping.lastName" placeholder="Last name"
                                class="p-3 border border-gray-300 rounded-lg w-full bg-white" />
                        </div>
                        ...
                        <div class="grid md:grid-cols-3 gap-4">
                            ...
                            <input type="text" v-model="shipping.state" placeholder="State"
                                class="p-3 border border-gray-300 rounded-lg w-full bg-white" />
                            <input type="text" v-model="shipping.pinCode" placeholder="PIN code"
                                class="p-3 border border-gray-300 rounded-lg w-full bg-white" />
                        </div>
                        <label class="flex items-center space-x-2 text-sm">
                            <input type="checkbox" class="custom-checkbox" />
                ...
                <div class="mb-6">
                    <h2 class="text-2xl font-semibold mb-4 text-[#28574e]">Shipping method</h2>
                    <input type="text" placeholder="Enter your shipping address to view available shipping methods."
                        class="w-full p-3 border border-gray-300 rounded-lg bg-white" />
                </div>
                ...
                <div class="mb-6">
                    ...
                    <div class="border border-[#28574e] rounded-lg">
                        <div class="flex justify-between items-center bg-[#f5f5f5] p-4 rounded-t-lg">
                            <div class="text-lg font-semibold text-[#28574e]">PhonePe Payment Gateway (UPI, Cards &
                                NetBanking)</div>
                            <div class="xl:flex items-center grid grid-cols-2 space-x-2">
                                ...
                                <img src="https://cdn.shopify.com/shopifycloud/checkout-web/assets/c1.en/assets/rupay.Bl62X6PG.svg"
                                    alt="RuPay Logo" class="h-8" />
                                <!-- <span class="text-lg font-semibold text-[#28574e]">+3</span> -->
                            </div>
                        </div>
                        <div class="p-6 text-center bg-[#f9f9f9] border-t border-[#28574e] space-y-4">
                            <div class="flex justify-center">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="-270.8 371 102 52" class="zjrzY w-36 ">
                            ...
                            <p class="text-sm text-gray-700">
                                After clicking "Pay now," you will be redirected to PhonePe Payment Gateway (UPI, Cards
                ...
                <div class="mb-6">
                    <h2 class="text-2xl font-semibold mb-4 text-[#28574e]">Billing address</h2>
                    <div class="flex flex-col space-y-4 text-[#28574e]">
                        <label class="flex items-center space-x-2">
                            <input type="radio" name="billing-address" value="same" v-model="billingAddressOption"
                                class="custom-checkbox" />
                            <span>Same as shipping address</span>
                        </label>
                        <label class="flex items-center space-x-2">
                            <input type="radio" name="billing-address" value="different" v-model="billingAddressOption"
                                class="custom-checkbox" />
                        ...
                        <div v-if="billingAddressOption === 'different'" class="space-y-4">
                            <div class="grid md:grid-cols-2 gap-4">
                                <input type="text" v-model="billing.firstName" placeholder="First name (optional)"
                                    class="p-3 border border-gray-300 rounded-lg w-full bg-white" />
                                <input type="text" v-model="billing.lastName" placeholder="Last name"
                                    class="p-3 border border-gray-300 rounded-lg w-full bg-white" />
                            </div>
                            <input type="text" v-model="billing.address" placeholder="Address"
                                class="p-3 border border-gray-300 rounded-lg w-full bg-white" />
                            ...
                            <div class="grid md:grid-cols-3 gap-4">
                                ...
                                <input type="text" v-model="billing.state" placeholder="State"
                                    class="p-3 border border-gray-300 rounded-lg w-full bg-white" />
                                <input type="text" v-model="billing.pinCode" placeholder="PIN code"
                                    class="p-3 border border-gray-300 rounded-lg w-full bg-white" />
                            </div>
                        </div>
                    </div>
            ...
            <div class="bg-white p-6 rounded-lg shadow-lg lg:sticky lg:top-8 lg:h-fit">
                <h2 class="text-2xl font-semibold mb-4 text-[#28574e]">Order Summary</h2>
                <div class="space-y-4">
                    <div v-for="product in products" :key="product.id"
                        class="flex items-center space-x-4 text-[#28574e]">
                        <img :src="product.image" alt="Product Image" class="w-16 h-16 rounded-lg" />
                        <div>
                    ...
                    <div class="flex justify-between w-full items-center text-lg text-[#28574e]">
                    ...
                    <div class="flex justify-between items-center font-semibold text-xl text-[#28574e]">
                        <span>Total</span>
                        <span>₹{{ total }}</span>
                    </div>
                </div>
...
export default {
    ...
    methods: {
        submitOrder() {
            // Simulate order submission and print data to console
            console.log('Order Submitted:', {
                contact: this.contact,
                shipping: this.shipping,
                billing: this.billingAddressOption === 'same' ? this.shipping : this.billing,
